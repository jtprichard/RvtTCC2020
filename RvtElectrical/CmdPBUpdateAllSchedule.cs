...
namespace RvtElectrical
{
    ...
    public class CmdPBUpdateAllSchedule : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            IList<DevicePanel> devicePanels = DevicePanel.GetDevicePanels(doc);
            ...
            {
                TaskDialog.Show("Panel Schedule", "There are no compatible panels to circuit");
            }
